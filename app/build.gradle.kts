...
android {
    namespace = "com.fauzan.zainullah.bookingkonsultasiapp"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.fauzan.zainullah.bookingkonsultasiapp"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Coroutines untuk menangani proses background (networking)
